...
# Other
FAST_MODE = False # Change if you want the script to run faster (You can get flagged if you change it to True)
PAG_FAILSAFE = True # Only change if you know what you're doing!
PAG_WAIT_TIME = 1
PAG_START_SECONDS = 5
CHECK_LEVEL_UP_COUNTER = 2
